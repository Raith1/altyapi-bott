...
module.exports.run = async (bot, message, args) => {
    ...
    request(UR_L, function(err, resp, body) {
        ...
        if (KD == -1) {
            message.channel.send(":x: Geçersiz, profilinizin gizli olmadığından ve geçerli bir STEAMID64 veya Özel URL girdiğinizden emin olun!"); return;
        }
        ...
        var STAT = new Discord.RichEmbed()
            ...
            .setURL(UR_L)
            .setColor("0x#FF0000")
            .addField("KD Oranı", KD, true)
            .addField("Kazanma Sayısı", `${WIN}%`, true)
            .addField("Toplam Rehine Kurtarma Sayısı", HR, true)
            .addField("Toplam Oyunda Kazandığı Para(lar)", MONEY, true)
            .addField("Toplam Skor(lar)", SCORE, true)
            .addField("Toplam Öldürme(ler)", KILLS, true)
            .addField("Toplam Ölme(ler)", DEATHS, true)
            .addField("MVP", MVP, true)
            .addField("Toplam Bomba Kurma Sayısı", BS, true)
            .addField("Toplam Bomba Kurtarma Sayısı", BD, true)
            .addField("Toplam Kafadan Vuruş(lar)", HS, true);
