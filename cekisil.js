            ...
            msg.edit(':eight_pointed_black_star:| **Şimdi de ödülü yaz bakalım**').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  .setFooter(message.author.username + " (- BHDR Bot Çekiliş Sistemi)", message.author.avatarURL);
                  message.guild.channels.find("name" , room).send('<a:v16:538057641772056597> **ÇEKİLİŞ BAŞLADI** <a:v16:538057641772056597>' , {embed: giveEmbed}).then(m => {
                     let re = m.react('🎉');
                     setTimeout(() => {
                       ...
                       .setTitle(title)
                       .setColor("#f558c9")
			.setFooter("(- BHDR Bot Çekiliş Sistemi)")
                       .addField('Çekiliş Bitti !<a:v13:538057652916322304>',`Kazanan : ${gFilter} \nBitiş zamanı :`)
                       .setTimestamp()
                     m.edit('** <a:v13:538057652916322304> ÇEKİLİŞ BİTTİ <a:v13:538057652916322304>**' , {embed: endEmbed});
                       
                       var embedLel = new Discord.RichEmbed()
                        .setColor("#f558c9")
                        .setDescription("Ödülünü destek talebi açarak elde edebilirsin!").setFooter("(- BHDR Bot Çekiliş Sistemi)")
